    ...
    RowLayout {
        ...
        ColumnLayout{
              ...
              Rectangle{
                 ...
                 Rectangle{
                     //property real leftMargin:profilePageContainer.width*0.05
                     property real topMargin:profilePageContainer.height*0.05
                     id:nameContainer
                     width:profilePageContainer.width
                     height:profilePageContainer.width*0.2
                     //x:leftMargin
                     y: topMargin
                     color:"#D3D3D3"

                     HeadingText {
                           width:profilePageContainer.width*0.5
                           height:profilePageContainer.width*0.2
                           x:width/2
                           y:height/2
                           font.pixelSize: 30
                         ...
                         // y: topMargin
                          ...
                          Image{
                             ...
                             onStatusChanged:{
                                 ...
                                 if(profileImage.status == Image.Ready)
                                 {
                                     var canvasContext = backgroundCanvas.getContext('2d');

                                     canvasContext.drawImage(profileImage, 0, 0);
                          ...
                          onPaint: {
                              ...
                              var centreX= backgroundCanvas.width/2;
                              var centreY= backgroundCanvas.height/2;
                              var canvasContext = backgroundCanvas.getContext('2d');
